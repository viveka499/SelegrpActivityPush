  ...
  public class TerrainStepDefinition {
  ...
  public void enter_data_Reg(DataTable table) throws Throwable {
  ...
  Select sLicensePeriod = new Select(driver.findElement(By.id("user_licenceperiod")));
  sLicensePeriod.selectByVisibleText(data.get(8).get(1)); 
  //Thread.sleep(2000);
  
  Select sOccupation = new Select(driver.findElement(By.id("user_occupation_id")));
  ...
  public void success_Reg() throws Throwable { 
  ...
  public void payment_Successful() throws Throwable{ 
	  boolean purchase ;
  if(driver.findElement(By.xpath("//h2[text()='Payment successfull!']")).isDisplayed()) 
  { 
	  purchase = true; 
	  } 
  else { 
  ...
  File DestFile=new File("./target/Snapshott/Payment-SuccessfulPage.png");
